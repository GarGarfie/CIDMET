...
**CIDMET** (Cross-database Identification and De-duplication Matching Export Tool) — это настольное приложение для исследователей в области библиометрии. Оно принимает на вход локальную библиотеку ссылок в формате BibTeX и автоматически сопоставляет записи с экспортированными данными из трёх крупнейших академических баз данных — **Web of Science (WoS)**, **Scopus** и **Engineering Village (EI/Compendex)**, — после чего извлекает совпавшие подмножества в нативном формате каждой базы и предоставляет возможность объединённого экспорта с дедупликацией.

Это решает распространённую проблему библиометрического анализа: когда вам нужны экспортные файлы в формате конкретной базы данных (для таких инструментов, как VOSviewer, CiteSpace или Bibliometrix), содержащие только ссылки из вашего исследования, а не весь массив результатов поиска.
...
- **GUI с поддержкой перетаскивания** — построен на PySide6 (Qt), с отслеживанием прогресса и вкладками вывода
- **Двуязычная поддержка Scopus** — обработка экспорта Scopus на английском и китайском языках
...
| База данных | Форматы импорта | Экспорт подмножества | Объединённый экспорт |
|-------------|-----------------|----------------------|----------------------|
| Web of Science | TXT (теговый формат), XLS | TXT, XLS | TXT |
| Scopus | CSV, TXT (англ./кит.) | CSV, TXT | CSV |
...
Если вы используете CIDMET в своём исследовании, пожалуйста, рассмотрите возможность цитирования данного проекта.
